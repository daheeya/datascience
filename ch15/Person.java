...
class Main{
    public static void main(String[] args) {
        ...
        Set<Person> personSet = new HashSet<Person>(); // Set에 들어갈 객체 타입 : Person, HashSet<>(); : Person 생략 가능! 앞에 Set<Person>에 명기했기 때문에 컴파일러가 알아서 추가해줌
        ...
        // 결과값: personSet에 kavin이 두개 다 들어갔다. : 두 개를 다른 객체로 인식했다는 소리. -> 해시코드르 오버라이딩 하면 같은 해시코드를 가지도록 해서 같은 객체가 됨
        // 해시코드 오버라이딩 후 결과 값: personSet에 하나만 들어감!

        // 결과적으로 equals만 오버라이딩 하지 말고 hashcode도 오버라이딩 해주기!
    }
}
